...
var JEditor = /** @class */ (function (_super) {
    ...
    JEditor.prototype.fromJSON = function (data) {
        ...
        this.name = data.name || '';
        if (data.children) {
            data.children.sort(function (p1, p2) {
                var _a, _b;
                return (((_a = p1.data) === null || _a === void 0 ? void 0 : _a.zIndex) - ((_b = p2.data) === null || _b === void 0 ? void 0 : _b.zIndex)) || 0;
            });
            try {
...
var JImage = /** @class */ (function (_super) {
    ...
    function JImage(option) {
        ...
        _this = _super.call(this, __assign(__assign({ preserveRatio: true }, option), { nodeType: 'img', type: option.type || 'image', dataType: option.dataType || JImageData })) || this;
        // 如果保持宽高比，则不能拉伸到100%高
...
var JText = /** @class */ (function (_super) {
    ...
    function JText(option) {
        ...
        if (((_b = option.children) === null || _b === void 0 ? void 0 : _b.length) && !((_c = _this.data) === null || _c === void 0 ? void 0 : _c.text)) {
            ...
            (_d = _this.option) === null || _d === void 0 ? true : delete _d.children;
        }
...
var JBaseComponent = /** @class */ (function (_super) {
    ...
    function JBaseComponent(option) {
        ...
        var targetOption = __assign(__assign({}, (option.target || option)), { visible: true, data: {}, transformWatchProps: null, className: 'j-design-editor-component-target', style: {} });
        // 是否可以移动
    ...
    JBaseComponent.prototype.addChild = function (child) {
        ...
        if ((_c = (_b = child.option) === null || _b === void 0 ? void 0 : _b.children) === null || _c === void 0 ? void 0 : _c.length) {
            child.option.children.sort(function (p1, p2) {
                var _a, _b;
                return (((_a = p1.data) === null || _a === void 0 ? void 0 : _a.zIndex) - ((_b = p2.data) === null || _b === void 0 ? void 0 : _b.zIndex)) || 0;
            });
            try {
...
var JControllerItem = /** @class */ (function (_super) {
    ...
    function JControllerItem(option) {
        var _this = this;
        option.style = __assign({ pointerEvents: 'auto' }, option.style);
...
var JControllerComponent = /** @class */ (function (_super) {
    ...
    function JControllerComponent(option) {
        var _this = this;
        option.style = __assign(__assign({ itemStyle: {} }, option.style), { backgroundColor: 'transparent', pointerEvents: 'none' });
        option.dir = 'element';
    ...
    Object.defineProperty(JControllerComponent.prototype, "center", {
        get: function () {
            ...
            var center = this.editor.toEditorPosition({
    ...
    JControllerComponent.prototype.change = function (e) {
        ...
        switch (dir) {
            ...
            case 'scale': {
                var target = ((_b = this.target) === null || _b === void 0 ? void 0 : _b.target) || this.target;
                if (offX !== 0) {
    ...
    JControllerComponent.prototype.checkPreserveRatio = function (arg) {
        // 如果保持宽高比，则要计算比例不能变化
        // 宽度和高度的变化比例要一至
        if (this.preserveRatio && (arg.width || arg.height)) {
            ...
            var newWidth = width + arg.width;
            var newHeight = height + arg.height;
            if (newWidth / newHeight !== per) {
                var w = newWidth, h = newHeight;
                // 如果不一至，则取变化更小的比例
                if (Math.abs(arg.width) < Math.abs(arg.height)) {
                    h = w / per;
                    arg.height = h - height;
                    var offy = h - newHeight;
                    if (arg.y) {
                        arg.y -= offy;
                    }
                }
    ...
    JControllerComponent.prototype.bindTargetPositionAndSize = function () {
        ...
        if (!this.target)
            return;
        this.preserveRatio = !!((_a = this.target.option) === null || _a === void 0 ? void 0 : _a.preserveRatio);
