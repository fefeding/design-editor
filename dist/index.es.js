...
var JEditor = exports.JEditor = /** @class */function (_super) {
  ...
  JEditor.prototype.resize = function (width, height) {
    ...
    this._resizeTimer = setTimeout(function () {
      _this.data.left = Math.max((_util["default"].toNumber(_this.view.dom.clientWidth) - _util["default"].toNumber(width)) / 2, 0);
      _this.data.top = Math.max((_util["default"].toNumber(_this.view.dom.clientHeight) - _util["default"].toNumber(height)) / 2, 0);
